...
import cheap.thrills.adapters.TicketViewAdapter3;
...
public class TicketTempletActivity3 extends BaseActivity {

    private static final String TAG = "TicketTempletActivity3";
    private RecyclerView rvTickets;
    private List<Order> orderList;
    private TicketViewAdapter3 ticketViewAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            getWindow().setStatusBarColor(ContextCompat.getColor(this, R.color.bg_blue));
            getWindow().setFlags(WindowManager.LayoutParams.FLAG_BLUR_BEHIND,
                    WindowManager.LayoutParams.FLAG_BLUR_BEHIND);
        }
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_SECURE, WindowManager.LayoutParams.FLAG_SECURE);
        setContentView(R.layout.activity_ticket_templet3);
        ...
        if (!(orderList == null)) {
            ticketViewAdapter = new TicketViewAdapter3(orderList, TicketTempletActivity3.this, UniversalOrlandoPreference.readString(TicketTempletActivity3.this, UniversalOrlandoPreference.THEMEPARK_NAME, ""));
            rvTickets.setAdapter(ticketViewAdapter);
        }

        constraintLayou2 = (ConstraintLayout) findViewById(R.id.constraintLayou2);
        Bitmap originalBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.bg_cf);
        ...
        btnViewTickets.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                showProgressDialog(TicketTempletActivity3.this);
                RestClient.get().ticketsList(UniversalOrlandoPreference.readString(TicketTempletActivity3.this, UniversalOrlandoPreference.MOBILE, ""), UniversalOrlandoPreference.readString(TicketTempletActivity3.this, UniversalOrlandoPreference.LOGIN_ID, "")).enqueue(new Callback<Profile>() {
                    @Override
                    public void onResponse(Call<Profile> call, Response<Profile> response) {
                        dismissProgressDailog();
                        if (response.isSuccessful()) {
                            orderList = response.body().getOrderDetails();
                            UniversalOrlandoPreference.writeString(TicketTempletActivity3.this, UniversalOrlandoPreference.THEMEPARK_NAME, response.body().getThemeParkName());
                            if (!(orderList == null)) {
                                ticketViewAdapter = new TicketViewAdapter3(orderList, TicketTempletActivity3.this, UniversalOrlandoPreference.readString(TicketTempletActivity3.this, UniversalOrlandoPreference.THEMEPARK_NAME, ""));
                                rvTickets.setAdapter(ticketViewAdapter);
                            }
                            ...
                            if (Integer.valueOf(response.body().getStatus()) == 404) {
                                alertErrorDialog(TicketTempletActivity3.this, response.body().getMessage());
                            ...
                            showToastAlert(TicketTempletActivity3.this, "Tickets are not found");
                        }
                    }
        ...
        btnLogout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                logOut(TicketTempletActivity3.this);
            }
        });
    ...
    protected void onResume() {
        ...
        if (checkLocationPermission()) {
            Intent intent = new Intent(TicketTempletActivity3.this, LocationService.class);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                getApplicationContext().startForegroundService(intent);
            } else getApplicationContext().startService(intent);
        }

        Log.d("testttting", "ticket template3 ");
    }
